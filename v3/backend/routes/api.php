...
Route::get('/interviews/{id}/rt/stream/{sid}', [RealtimeInterviewController::class, 'stream']);
Route::get('/interviews/{id}/rt/ws/{sid}', [RealtimeInterviewController::class, 'websocket'])->name('interview.realtime.ws');
